...
public class CSNewParameters
{
    public static void main (String args[])
    {
        ...
        eae.setDistP1((int)0.5);// mapped by parm1
        man.AddActiveState(eae);
        ...
        iae.setDistP1((int)180);// mapped by parm1
        ...
        iae.setDistP1((int)0.033);// mapped by parm1
        iae.addCond("true");
        iae.addToQueue("Q_A2");// mapped by next dead
        ...
        iae.setServiceDist(ActiveEntry.NORMAL);// mapped by stat type
        iae.setDistP1((int)25);// mapped by parm1
        iae.setDistP2((int)8); //mapped by parm2
        iae.addCond("true");
        iae.addToQueue("Q_A2");// mapped by next dead
        ...
        iae.setServiceDist(ActiveEntry.NORMAL);// mapped by stat type
        iae.setDistP1((int)3.25);// mapped by parm1
        ...
        iae.setServiceDist(ActiveEntry.NEGEXP);// mapped by stat type
        iae.setDistP1((int)18);// mapped by parm1
        iae.addCond("true");
        ...
        man.OutputSimulationResults ("CONTROL_STRUCTURE_NEW_PARAMETERS.out");
