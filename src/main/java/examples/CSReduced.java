...
public class CSReduced
{
    public static void main (String args[])
    {
        //Reduzida, não contem generate vehicles nem FB2
        ...
        iae.setDistP1((int)20.0);// mapped by parm1
        iae.addCond("true");
        ...
        iae.setServiceDist(ActiveEntry.NEGEXP);// mapped by stat type
        iae.setDistP1((int)2.0);// mapped by parm1
        iae.addCond("true");
...
//
//        man.OutputSimulationResults ("CS_REDUCED_.out");
//
//
//        System.out.println("\nThat's all folks!");

        int numExecucoes = 10;   // quantidade de vezes que você quer rodar
        int tempoSimulacao = 500;

        for (int i = 1; i <= numExecucoes; i++) {

            System.out.println("\n==============================");
            System.out.println("Iniciando simulação #" + i);
            System.out.println("==============================\n");

            // inicia a simulação
            System.out.println("Starting the simulation. Simulation will run until time=" + tempoSimulacao);
            man.ExecuteSimulation(tempoSimulacao);
            ...
            // salva resultados para cada execução com sufixo diferente
            String filename = "CS_REDUCED_exec_" + i + ".out";
            man.OutputSimulationResults(filename);
