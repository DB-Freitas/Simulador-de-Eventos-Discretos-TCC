...
public class SimulationSCCI_v2_ex {
    public static void main(String args[]) {
        //GROUPED SENSORS AND INTERNAL COMPONENT REPRESENTATION.
        ...
        resource = new ResourceEntry();
        resource.SetId("CONTROL_ALGORITHM");
        resource.setInit((short) 1);
        resource.setObsid("CONTROL_ALGORITHM_OBS");
        man.AddResource(resource);
        ...
        internalActivity = new InternalActiveEntry(true);
        internalActivity.SetId("A_4");
        internalActivity.setObsid("A_4_OBS");
        internalActivity.setServiceDist(ActiveEntry.CONST);
        internalActivity.setDistP1(0.3f);
        internalActivity.addFromQueue("Q_16");
        internalActivity.addToQueue("Q_13");
        internalActivity.addToResource("CONTROL_ALGORITHM");
        internalActivity.addResourceQty(1);
        internalActivity.addFromResource("CONTROL_ALGORITHM");
        internalActivity.addCond("true");
        man.AddActiveState(internalActivity);
        ...
        observer = new ObserverEntry(ObserverEntry.RESOURCE, "CONTROL_ALGORITHM");
        ...
        observer = new ObserverEntry(ObserverEntry.ACTIVE, "A_4");
        observer.SetId("A_4_OBS");
        observer.setName(observer.GetId());
        man.AddObserver(observer);
        ...
        man.OutputSimulationResults("SimulationSCCI_v2_ex.out");
        System.out.println("\nProcess finished!");
    }
}
